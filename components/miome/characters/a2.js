...
function a(svg, x, ypos, xoff, yoff, fontsize, weight, wig, id, update, color) {
  ...
  if (!update) {
    ...
    //     } M${x}, ${ypos}L${x + fontsize}, ${ypos}  M${x}, ${ypos - fontsize}L${
    //       x + fontsize
    //     }, ${ypos - fontsize} M${x}, ${ypos - fontsize / 2}L${x + fontsize}, ${
    //       ypos - fontsize / 2
    //     }`
    //   )
    //   .attr("fill", "none")
