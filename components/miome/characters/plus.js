...
function plus(
  ...
  //bottom segment -----------------
  path.moveTo(xpos + width / 2 + xbotoff - strokewidth / 2, ypos - ybotoff);
  path.lineTo(
    xpos + width / 2 + xbotoff - strokewidth / 2,
    ypos - segmentheight - ybotoff
  );

  //top segment -----------------
  path.moveTo(
    xpos + width / 2 + xtopoff - strokewidth / 2,
  ...
  path.lineTo(middlex + width - strokewidth / 2, center);
