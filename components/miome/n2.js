...
function n(svg, x, ypos, xoff, yoff, fontsize, weight, wig, id, update, cons) {
  //  console.log("called");
  ...
  let ctrlHeight = (-ybotoff + ytopoff) / (wig / 1.7);
  //bottom segment -----------------
  ...
  wiggle(
    path,
    xpos + xtopoff,
    ypos - segmentheight - ytopoff - segmentheight / 2,
    xpos + xbotoff,
    ypos - segmentheight - ybotoff + segmentheight / 2,
    ctrlHeight
  );
